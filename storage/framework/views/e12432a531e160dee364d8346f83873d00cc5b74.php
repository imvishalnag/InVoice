            ...
            <div class="container">
                <div class="row">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo e(route('web.news', ['id'=> encrypt(12)])); ?>"><span class="catTitle">INDIA</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('web.news', ['id'=> encrypt(13)])); ?>"><span class="catTitle">WORLD</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('web.news', ['id'=> encrypt(2)])); ?>"><span class="catTitle">GUWAHATI</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('web.news', ['id'=> encrypt(1)])); ?>"><span class="catTitle">ASSAM</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('web.news', ['id'=> encrypt(14)])); ?>"><span class="catTitle">NORTHEAST</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('web.news', ['id'=> encrypt(16)])); ?>"><span class="catTitle">SPORTS</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('web.news', ['id'=> encrypt(15)])); ?>"><span class="catTitle">ENTERTAINMENT</span></a>
                        </li>
                        <li>
...
</html><?php /**PATH E:\xampp\htdocs\newstimenortheast\resources\views/web/include/footer.blade.php ENDPATH**/ ?>