...
<body>
	...
	<div class="body-inner">
			               ...
			               <!-- End of Navbar toggler -->
							...
							<div id="navbarSupportedContent" class="collapse navbar-collapse navbar-responsive-collapse">
								<ul class="nav navbar-nav">
									<li>
										<a href="<?php echo e(route('web.index')); ?>">Home </a>
									</li>
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu" role="menu">
											<li>
												<a href="<?php echo e(route('web.news', ['id'=> encrypt(12)])); ?>">India</a>
											</li>
											<li>
												<a href="<?php echo e(route('web.news', ['id'=> encrypt(13)])); ?>">World</a>
											</li>
										</ul><!-- End dropdown -->
									</li><!-- Features menu end -->

									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(2)])); ?>">Guwahati</a>
									</li>
									...
									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(15)])); ?>">Entertainment</a>
									</li>
		...
		</div><!-- Menu wrapper end --><?php /**PATH E:\xampp\htdocs\newstimenortheast\resources\views/web/include/header.blade.php ENDPATH**/ ?>