    ...
    <script>
        $(function(){
            var table = $('#post_list').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('admin.ajax.get_ass_post_list')); ?>",
                columns: [
...
<?php echo $__env->make('admin.template.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\invoicene\resources\views/admin/ass_list_post.blade.php ENDPATH**/ ?>