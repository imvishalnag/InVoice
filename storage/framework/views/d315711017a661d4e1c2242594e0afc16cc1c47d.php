...
<body>
	...
	<div class="body-inner">
		        ...
		        <div class="row">
		            <div class="col-md-8">
		               ...
		               <ul class="unstyled top-nav">
		                  	...
		                  	<li><a href="<?php echo e(route('assamese.index')); ?>">অসমীয়া</a></li>
		               </ul>
			               ...
			               <!-- End of Navbar toggler -->
							...
							<div id="navbarSupportedContent" class="collapse navbar-collapse navbar-responsive-collapse">
								<ul class="nav navbar-nav">
									...
									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(14)])); ?>">Northeast</a>
									</li>

									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(12)])); ?>">National</a>
									</li>

									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(13)])); ?>">International</a>
									</li>

									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(2)])); ?>">Politics</a>
									</li>

									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(2)])); ?>">Economy</a>
									</li>

									<li>
										<a href="<?php echo e(route('web.news', ['id'=> encrypt(2)])); ?>">Crime</a>
									</li>
		...
		</div><!-- Menu wrapper end --><?php /**PATH C:\xampp\htdocs\InVoice\resources\views/web/include/header.blade.php ENDPATH**/ ?>