...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                                ...
                                                <img src="<?php echo e(asset('post/thumb/'.$posts->image)); ?>" alt="<?php echo e($posts->image); ?>" width="100" height="100">
...
<?php echo $__env->make('admin.template.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\invoicene\resources\views/admin/edit_post.blade.php ENDPATH**/ ?>