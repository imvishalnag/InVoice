                ...
                <div class="row">
                    ...
                    <ul>
                        <li>
                            ...
                            <img src="<?php echo e(asset('web/images/andriod.jpg')); ?>" alt="">
                        </li>                        
                    </ul>
                    </div><!-- Col end -->
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo e(route('ass.news', ['id'=> encrypt(12)])); ?>"><span class="catTitle">ভাৰতবৰ্ষ</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('ass.news', ['id'=> encrypt(13)])); ?>"><span class="catTitle">বিশ্ব</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('ass.news', ['id'=> encrypt(2)])); ?>"><span class="catTitle">গুৱাহাটী</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('ass.news', ['id'=> encrypt(1)])); ?>"><span class="catTitle">অসম</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('ass.news', ['id'=> encrypt(14)])); ?>"><span class="catTitle">উত্তৰপূব</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('ass.news', ['id'=> encrypt(16)])); ?>"><span class="catTitle">ক্ৰীড়া</span></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('ass.news', ['id'=> encrypt(15)])); ?>"><span class="catTitle">মনোৰঞ্জণ</span></a>
                        </li>
                        <li>
                            <a href="#"><span class="catTitle">ভিডিও</span></a>
                        </li>
                        <li>
                            <a target="_blank" href="<?php echo e(route('web.livetv.livetv')); ?>"><span class="catTitle">LIVE TV</span></a>
                        </li>
                    </ul>                    
                    ...
                    <div class="footer-info-content">
                        <div class="footer-logo">
                            <img class="img-fluid" src="<?php echo e(asset('web/images/logos/logo.png')); ?>" alt="" />
                        </div>
...
</html><?php /**PATH E:\xampp\htdocs\newstimenortheast\resources\views/as/include/footer.blade.php ENDPATH**/ ?>