                    ...
                    <div class="single-post">
                        ...
                        <div class="post-content-area">
                            <div class="post-media post-featured-image">
                                <a href="<?php echo e(asset('web/images/news/lifestyle/health5.jpg')); ?>" class="gallery-popup"><img src="<?php echo e(asset('web/images/news/lifestyle/health5.jpg')); ?>" class="img-fluid" alt=""></a>
                            </div>
                            <div class="entry-content">
                                ...
                                <p><img src="<?php echo e(asset('web/images/news/news-details/news-details1.jpg')); ?>" class="img-fluid" alt=""></p>
                    ...
                    <div class="related-posts block">
                        ...
                        <div id="latest-news-slide" class="owl-carousel owl-theme latest-news-slide">
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="<?php echo e(asset('web/images/news/lifestyle/travel5.jpg')); ?>" alt="" /></a>
                                    </div>
                                    <a class="post-cat" href="#">Health</a>
                            ...
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="<?php echo e(asset('web/images/news/lifestyle/health5.jpg')); ?>" alt="" /></a>
                                    </div>
                                    <a class="post-cat" href="#">Health</a>
                                    <div class="post-content">
                                        <h2 class="post-title title-medium">
                            ...
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="<?php echo e(asset('web/images/news/lifestyle/travel3.jpg')); ?>" alt="" /></a>
                                    </div>
                            ...
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="<?php echo e(asset('web/images/news/lifestyle/travel4.jpg')); ?>" alt="" /></a>
                                    </div>
                                    <a class="post-cat" href="#">Travel</a>
                                    <div class="post-content">
                                        <h2 class="post-title title-medium">
                    ...
                    <div class="sidebar sidebar-right">
                        ...
                        <div class="widget color-default">
                            ...
                            <div class="post-overaly-style clearfix">
                                <div class="post-thumb">
                                    <a href="#">
                                        <img class="img-fluid" src="<?php echo e(asset('web/images/news/lifestyle/health4.jpg')); ?>" alt="" />
                                    </a>
                                </div>
                                ...
                                <ul class="list-post">
                                    <li class="clearfix">
                                        <div class="post-block-style post-float clearfix">
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-fluid" src="<?php echo e(asset('web/images/news/tech/gadget3.jpg')); ?>" alt="" />
                                                </a>
                                    ...
                                    <li class="clearfix">
                                        <div class="post-block-style post-float clearfix">
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-fluid" src="<?php echo e(asset('web/images/news/lifestyle/travel5.jpg')); ?>" alt="" />
                                                </a>
                                                <a class="post-cat" href="#">Travel</a>
                                            </div><!-- Post thumb end -->
                                    ...
                                    <li class="clearfix">
                                        <div class="post-block-style post-float clearfix">
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-fluid" src="<?php echo e(asset('web/images/news/tech/robot5.jpg')); ?>" alt="" />
                                                </a>
                                    ...
                                    <li class="clearfix">
                                        <div class="post-block-style post-float clearfix">
                                            <div class="post-thumb">
                                                <a href="#">
                                                    <img class="img-fluid" src="<?php echo e(asset('web/images/news/lifestyle/food1.jpg')); ?>" alt="" />
                                                </a>
