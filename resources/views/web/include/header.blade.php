			               ...
			               <!-- End of Navbar toggler -->
							...
							<div id="navbarSupportedContent" class="collapse navbar-collapse navbar-responsive-collapse">
								<ul class="nav navbar-nav">
									...
									<li>
										<a href="{{route('web.news', ['id'=> encrypt(12)])}}">National</a>
									</li>

									<li>
										<a href="{{route('web.news', ['id'=> encrypt(13)])}}">International</a>
									</li>

									<li>
										<a href="{{route('web.news', ['id'=> encrypt(2)])}}">Politics</a>
									</li>

									<li>
										<a href="{{route('web.news', ['id'=> encrypt(2)])}}">Economy</a>
									</li>

									<li>
										<a href="{{route('web.news', ['id'=> encrypt(2)])}}">Crime</a>
									</li>
