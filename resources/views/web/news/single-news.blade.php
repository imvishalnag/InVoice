                    ...
                    <div class="single-post">
                        ...
                        <div class="post-content-area">
                            <div class="post-media post-featured-image">
                                <a href="{{asset('web/images/news/lifestyle/health5.jpg')}}" class="gallery-popup"><img src="{{asset('web/images/news/lifestyle/health5.jpg')}}" class="img-fluid" alt=""></a>
                            </div>
                    ...
                    <div class="related-posts block">
                        ...
                        <div id="latest-news-slide" class="owl-carousel owl-theme latest-news-slide">
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="{{asset('web/images/news/lifestyle/travel5.jpg')}}" alt="" /></a>
                                    </div>
                                    <a class="post-cat" href="#">Health</a>
                            ...
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="{{asset('web/images/news/lifestyle/health5.jpg')}}" alt="" /></a>
                                    </div>
                                    <a class="post-cat" href="#">Health</a>
                                    <div class="post-content">
                                        <h2 class="post-title title-medium">
                            ...
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="{{asset('web/images/news/lifestyle/travel3.jpg')}}" alt="" /></a>
                                    </div>
                            ...
                            <div class="item">
                                <div class="post-block-style clearfix">
                                    <div class="post-thumb">
                                        <a href="#"><img class="img-fluid" src="{{asset('web/images/news/lifestyle/travel4.jpg')}}" alt="" /></a>
                                    </div>
                                    <a class="post-cat" href="#">Travel</a>
                                    <div class="post-content">
                                        <h2 class="post-title title-medium">
