                    ...
                    <div class="featured-tab">
                        ...
                        <div class="slideshow-container">
                            ...
                            <div class="mySlides fade">
                              ...
                              <img src="{{('web/images/news/video/video3.jpg')}}" style="width:100%">
                              <div class="text">
                                  <div class="post-content">
                            ...
                            <div class="mySlides fade">
                              ...
                              <img src="{{('web/images/news/video/video2.jpg')}}" style="width:100%">
                              <div class="text">
                                  <div class="post-content">
                                     <h2 class="post-title title-small">
                                         <a href="#">Netcix cuts out the chill with an integrated...</a>
                            ...
                            <div class="mySlides fade">
                              ...
                              <img src="{{('web/images/news/video/video1.jpg')}}" style="width:100%">
                              <div class="text">
                                  <div class="post-content">
                                     <h2 class="post-title title-small">
                                         <a href="#">Netcix cuts out the chill with an integrated...</a>
